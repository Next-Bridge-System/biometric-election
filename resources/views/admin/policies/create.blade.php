            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('policies.store')}}" method="POST" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Policy Image: <span class="text-danger">*</span></label>
                                            <input type="file" id="policy_url" name="policy_url" class="form-control"
                                                   accept="image/jpg,image/jpeg,image/png" required>
                                            <img src="{{ old('policy_url') }}" alt="">
                                            @error('policy_url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
