...
<div class="modal fade" id="upload_payment_modal_{{$payment->id}}" tabindex="-1"
    ...
    <div class="modal-dialog">
        <form action="" method="POST" id="hc_upload_payment_form_{{$payment->id}}">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="upload_payment_modal_label_{{$payment->id}}">Payment vouhcer #{{$payment->voucher_no}}
                    </h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <a href="javascript:void(0)" class="btn btn-danger btn-sm"
                            ...
                            onclick="removeHcVoucherFile(this,6)">Remove {{$payment->voucher_name}}</a>
                        @endif
                        @else
