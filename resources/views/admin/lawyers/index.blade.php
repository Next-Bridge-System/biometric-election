        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    @if (Auth::guard('admin')->user()->hasPermission('add-lawyers'))
                    <li class="breadcrumb-item">
                        <a href="{{route('lawyers.create-step-1')}}" class="btn btn-success">
                            <i class="fas fa-plus mr-1" aria-hidden="true"></i> Add Existing Lawyer
                        </a>
                    </li>
                    @endif
                </ol>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            Existing Lawyers List (Total Existing Lawyers : {{$count}})
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{route('lawyers.index')}}" method="POST" id="search_application_form"> @csrf
