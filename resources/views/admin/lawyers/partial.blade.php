            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            Partial Applications (Total Partial Applications : {{$count}})
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{route('lawyers.partial')}}" method="POST" id="search_application_form"> @csrf
