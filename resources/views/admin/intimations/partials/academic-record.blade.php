...
<tr>
    ...
    <td>
        <a href="javascript:void(0)" data-action="{{route('intimations.destroy.academic-record',$education->id)}}"
            onclick="removeDocument(this)">
            <span class="badge badge-danger"><i class="fas fa-remove mr-1"></i>Remove</span>
        </a>
    </td>
</tr>
@empty
