    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sendMessageModalLabel">Send Messages</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="#" id="send_messages_form" method="POST"> @csrf
                        ...
                        <body>
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-primary btn-sm"
                                        onclick="sendMessageIntimation(1)">Send it</button></td>
                            </tr>
                            <tr>
                                <th>OTP Message</th>
                                <td><button type="button" class="btn btn-primary btn-sm"
                                        onclick="sendMessageIntimation(2)">Send it</button></td>
                            </tr>
                            <tr>
                                <th>Application Message</th>
                                <td><button type="button" class="btn btn-primary btn-sm"
                                        onclick="sendMessageIntimation(3)">Send it</button></td>
                            </tr>
                        </body>
                    </table>
                </div>
...
<script>
    function sendMessageIntimation(message_type) {
