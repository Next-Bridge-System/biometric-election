...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>High Court - License Report</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <form action="{{route('reports.high-court.license.export')}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-2 form-group">
                                    ...
                                    <select class="form-control custom-select" id="sort_by" name="sort_by">
                                        <option value="1">Lawyer Name</option>
                                        <option value="2">License Number</option>
                                    </select>
                                </div>
                                <div class="col-md-2 form-group">
    ...
    jQuery(document).ready(function () {
        ...
        $(document).ready(function () {
            table = $('#applications_table').DataTable({
                ...
                "searching": true,
                ajax: {
                    url: "{{ route('reports.high-court.license.index') }}",
                    data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'enr_date_hc', name: 'enr_date_hc'},
                    {data: 'voter_member_hc', name: 'voter_member_hc'},
                    {data: 'mobile_no', name: 'mobile_no'},
                    {data: 'cnic_no', name: 'cnic_no'},
                    {data: 'bf_no_hc', name: 'bf_no_hc'},
                ],
            ...
            $('#application_status, #payment_status, #card_status, #bar_id, #custom_date_input, #rcpt_date_input, #license_no, #sort_by').change(function () {
                table.draw();
            });
