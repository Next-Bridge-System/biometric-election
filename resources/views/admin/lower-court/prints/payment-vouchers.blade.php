...
<head>
    ...
    <title>Voucher - 00{{$application->id}}</title>
...
<body>
    <div class="row">
        ...
        <div class="column">
            ...
            @php
            $one_link_number = getLcBank1LinkNumber($payment->voucher_type);
            @endphp
            ...
            <table class="table">
                ...
                <tr>
                    <td colspan="2" style="text-align: center; padding:14px;font-size:12px">Habib Bank Limited (HBL)
                        <br> <b>{{getLcBankAccount($payment->voucher_type)}}</b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>CNIC No:</td>
                    <td>{{$application->cnic_no}} <br>
                        <small><b>(Age: {{convertLcAgeToWords($application->age)}})</b></small>
                    </td>
                </tr>
                <tr>
                    <td>Contact No:</td>
