...
<head>
    ...
    <title>Lower Court Application - {{$application->id}}</title>
</head>
...
<body>
    <table id="section-to-print">
        ...
        <tr style="text-align: center">
            <td>
                <h4>Lower Court Application # :</h4>
                <h1>{{$application->id}}</h1>
            </td>
        </tr>
        <tr style="text-align: center">
            <td style="font: 16px;">
                <b>Name:</b> <span>{{$application->lawyer_name}}</span> <br>
                <b>Cnic:</b> <span>{{$application->cnic_no}}</span> <br>
                <b>Status:</b> <span>{!!appStatus($application->app_status, $application->app_type)!!}</span>
            </td>
        </tr>
        <tr>
            <td>
