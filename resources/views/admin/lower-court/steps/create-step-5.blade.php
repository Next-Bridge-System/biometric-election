<form class="steps-form" data-action="{{ route('lower-court.create-step-5',$application->id) }}" action="#"
        ...
        <fieldset class="border p-4 mb-4">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="srl_bar_id" id="srl_bar_id" class="form-control custom-select" required>
    ...
    <div class="card-footer">
        ...
        <a href="javascript:void(0)" onclick="goToStep('{{route('lower-court.create-step-4', $application->id)}}',4)"
