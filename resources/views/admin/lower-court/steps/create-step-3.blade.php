<form class="steps-form" action="#" data-action="{{route('lower-court.create-step-3',$application->id)}}" method="POST"
    id="create_step_3_form" enctype="multipart/form-data"> @csrf
    <div class="card-body">
        ...
        <fieldset class="border p-4 mb-4">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="ha_country_id" class="form-control custom-select" id="ha_country_id">
                ...
                <div class="form-group col-md-6 ha_pakistan_section">
                    ...
                    <select name="ha_province_id" class="form-control custom-select" id="ha_province_id">
                ...
                <div class="form-group col-md-6 ha_pakistan_section">
                    ...
                    <select name="ha_district_id" class="form-control custom-select" id="ha_district_id">
                ...
                <div class="form-group col-md-6 ha_pakistan_section">
                    ...
                    <select name="ha_tehsil_id" class="form-control custom-select" id="ha_tehsil_id">
        ...
        <fieldset class="border p-4 mb-4">
            ...
            {{$application->address->same_as == 1 ? 'hidden' : ''}} @else hidden
                ...
                <div class="form-group col-md-6">
                    <label>Country: <span class="text-danger">*</span></label>
                    <select name="pa_country_id" class="form-control custom-select postal_address" id="pa_country_id">
                        <option value="">--Select Country--</option>
                        @foreach ($countries as $country)
                ...
                <div class="form-group col-md-6 pa_pakistan_section">
                    <label>Province/State: <span class="text-danger">*</span></label>
                    <select name="pa_province_id" class="form-control custom-select postal_address" id="pa_province_id">
                        <option value="">--Select Province--</option>
                        @foreach ($provinces as $province)
                ...
                <div class="form-group col-md-6 pa_pakistan_section">
                    <label>District : <span class="text-danger">*</span></label>
                    <select name="pa_district_id" class="form-control postal_address custom-select" id="pa_district_id">
                ...
                <div class="form-group col-md-6 pa_pakistan_section">
                    <label>Tehsil : <span class="text-danger">*</span></label>
                    <select name="pa_tehsil_id" class="form-control postal_address custom-select" id="pa_tehsil_id">
                        <option value="" selected>Select</option>
                        <option value="">--Select Tehsil--</option>
    ...
    <div class="card-footer">
        ...
        <a href="javascript:void" onclick="goToStep('{{route('lower-court.create-step-2', $application->id)}}',2)"
