<form class="steps-form" data-action="{{ route('lower-court.create-step-6',$application->id) }}" action="#"
    ...
    <div class="card-footer">
        ...
        <a href="javascript:void(0)" onclick="goToStep('{{route('lower-court.create-step-5', $application->id)}}',5)"
