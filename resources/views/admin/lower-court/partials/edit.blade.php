...
<button type="button" class="btn btn-primary btn-sm float-right m-1" data-toggle="modal" data-target="#exampleModal">
    <i class="fas fa-edit mr-1" aria-hidden="true"></i>Edit-2
</button>

<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="#" method="POST" id="lc_update_form" enctype="multipart/form-data"> @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Lower Court Application</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" name="enr_date" id="enr_date" class="form-control"
                                value="{{$application->date_of_enrollment_lc}}">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="address_1" id="address_1" class="form-control"
                                value="{{$application->address->ha_str_address ?? ''}}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="">Address 2:</label>
                            <input type="text" name="address_2" id="address_2" class="form-control"
                                value="{{$application->address->ha_town ?? ''}}">
                        </div>
