@if ($application->is_final_submitted == 1 && Route::currentRouteName() == 'lower-court.show')
<section>
    @if ($application->app_status == 6)
    <form action="#" method="POST" id="lc_status_form"> @csrf
        <div class="mt-2">
    ...
    <div class="modal fade" id="update_app_status_modal" tabindex="-1" aria-labelledby="update_app_status_modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="#" id="update_status_form" method="POST"> @csrf
