...
<button type="button" class="btn btn-primary float-right btn-sm m-1" data-toggle="modal" data-target="#lcNotesModal">
    <i class="far fa-copy mr-1"></i>Notes
    <span class="badge badge-warning ml-1">{{$application->additional_notes->count()}}</span>
</button>

<!-- Modal -->
<div class="modal fade" id="lcNotesModal" tabindex="-1" aria-labelledby="lcNotesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="lcNotesModalLabel">Lower Court Notes</h5>
            ...
            <div class="modal-body">
                <div class="form-group col-md-12">
                    <form action="#" id="lc_notes_form" method="POST"> @csrf
                        <div class="form-group" id="notes">
                            <textarea type="text" name="lc_notes" id="lc_notes" class="form-control textarea"
                                rows="6"></textarea>
                        </div>
