    ...
    <div class="row">
        <div class="table-responsive">
            <table class="table table-striped table-sm table-bordered" id="lc-table">
                ...
                <tr>
                    @if($application->is_final_submitted && Route::currentRouteName() == 'lower-court.show')
                    <th>Download Vouchers:</th>
                    <td colspan="2"><a
                            href="{{route('lower-court.prints.bank-voucher',['download'=>'pdf','lower_court_id' => $application->id])}}"
            ...
            <table class="table table-striped table-sm table-bordered" id="lc-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{(route('lower-court.payment', [$application->id,$payment->voucher_type]))}}"
                ...
                @if (Route::currentRouteName() == 'frontend.lower-court.show')
                <tr>
                    @if ($payment->payment_status == 0)
                    <td>
                        @include('admin.lower-court.partials.payment-upload-modal')
                    </td>
                    @endif
                </tr>
                @endif
