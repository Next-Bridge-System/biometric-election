<button type="button" class="btn btn-primary float-right btn-sm m-1" data-toggle="modal"
    data-target="#vppNumberImport">VPP Number Import</button>
<div class="modal fade" id="vppNumberImport" tabindex="-1" aria-labelledby="vppNumberImportLabel" aria-hidden="true">
    <form action="#" id="vpp_number_import" method="POST"> @csrf
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="vppNumberImportLabel">VPP Number - Excel Import</h5>
