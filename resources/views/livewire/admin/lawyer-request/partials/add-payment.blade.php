    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <input type="file" wire:model="lawyer_request_voucher_file">

                                @if ($lawyer_request_voucher_file)
                                <img src="{{ $lawyer_request_voucher_file->temporaryUrl() }}" class="custom-image-preview mt-2">
                                @endif

                                @if (!$lawyer_request_voucher_file)
                                <span wire:ignore>
                                    <img src="{{ asset('storage/app/public/'.$payment->lawyer_request_voucher_file)}}"
                                        class="custom-image-preview mt-2">
                                </span>
                                @endif

                                <div>
                                    @error('lawyer_request_voucher_file') <span class="text-danger">
                                        {{ $message}}</span>
                                    @enderror
                                </div>
                            </td>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" wire:click="add_payment()">Save
                    changes</button>
            </div>
        </div>
    </div>
