<form class="steps-form" action="#" data-action="{{route('frontend.lower-court.create-step-3',$application->id)}}"
    method="POST" id="create_step_3_form" enctype="multipart/form-data"> @csrf
    <div class="card-body">
    ...
    <div class="card-footer">
        ...
        <a href="javascript:void"
            onclick="goToStep('{{route('frontend.lower-court.create-step-2', $application->id)}}',2)"
