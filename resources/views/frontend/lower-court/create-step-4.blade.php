<form class="steps-form" action="#" data-action="{{route('frontend.lower-court.create-step-4', $application->id)}}"
    method="POST" id="lc_create_step_4_form" enctype="multipart/form-data"> @csrf
    <div class="card-body">
            ...
            <div class="row">
                <table class="table table-sm text-center" id="lawyer_academic_table">
                    ...
                    <tbody id="academicRecord">
                        @include('frontend.lower-court.partials.academic-record')
                    </tbody>
                </table>
            </div>
        </fieldset>
    ...
    <div class="card-footer">
        <a id="saveAndNext" href="javascript:void(0)" @if ($application->is_academic_record == false)
            data-target="#exampleModal" @endif class="btn btn-success float-right">Save & Next</a>
        ...
        <a href="javascript:void(0)"
            onclick="goToStep('{{route('frontend.lower-court.create-step-3', $application->id)}}',3)"
