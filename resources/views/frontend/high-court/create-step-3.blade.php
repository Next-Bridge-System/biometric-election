<form class="steps-form" action="#" data-action="{{route('frontend.high-court.create-step-3',$application->id)}}"
    ...
    <div class="card-footer">
        ...
        <a href="javascript:void"
            onclick="goToStep('{{route('frontend.high-court.create-step-2', $application->id)}}',2)"
