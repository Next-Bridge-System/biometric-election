...
<head>
    ...
    <title>BankIslami-Voucher-{{$application->application_token_no}}</title>
    ...
    <div class="row">
        ...
        <div class="column">
            ...
            <div style="text-align: center;">
                <img src="{{asset('public/admin/images/bank-islami.png')}}" alt=""
                    style="width: 120px; padding-right:70px">
            ...
            <div style="text-align: center;">
                ...
                <span style="font-size: 16px; font:bold;">BankIslami Pakistani Limited</span> <br>
            ...
            <table class="table">
                <tr>
                    ...
                    <td style=" padding: 15px">VOUCHER # <span style="font-size:18px;"><b>{{isset($payment) ?
                                $payment->voucher_no : 'N/A'}}</b></span></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center">Payable at any branch in Pakistan</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center"><b>Transactions to be processed via LinkIslami</b></td>
                </tr>
                <tr>
            ...
            <table>
                ...
                <tr style="text-align: center">
                    ...
                    <td style="padding-bottom:25px"> <b>{{$payment->amount}}/-</b> </td>
                </tr>
            </table>
            ...
            <table>
                <tr style="text-align: center">
                    ...
                    <td style="padding-bottom:35px"> {{$payment->amount}}/- </td>
                </tr>
            </table>
