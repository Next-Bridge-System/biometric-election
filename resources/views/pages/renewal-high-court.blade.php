...
<div class="d-flex justify-content-center">
    <h4 class="text-center">Renewal High Court</h4>
</div>

<div class="container">
    <form action="#" method="POST" id="renewal_high_court_form" enctype="multipart/form-data"> @csrf
        <div class="card-body">
            ...
            <fieldset class="border p-4 mb-4">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label>B.F No: <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group col-md-6">
                        <label>HCR No: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="hcr_no">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Date of Enrollment (L.C.): <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group col-md-6">
                        <label>Date of Enrollment (H.C.): <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group col-md-6">
                        <label>Voter Member (L.C.): <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group col-md-6">
                        <label>Voter Member (H.C.): <span class="text-danger">*</span></label>
            ...
            <fieldset class="border p-4 mb-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="Renewal High Court" readonly>
                    </div>
                </div>
            </fieldset>
...
<script>
    ...
    $(document).ready(function(){
      $("#renewal_high_court_form").on("submit", function(event){
          ...
          $.ajax({
              method: "POST",
              data: formData,
              url: '{{route('frontend.renewal-high-court')}}',
              processData: false,
              contentType: false,
              cache: false,
              beforeSend: function(){
              ...
              success: function (response) {
                if (response.status == 1) {
                    var url = '{{ route("frontend.view-renewal-high-court", ":id") }}';
